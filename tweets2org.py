...
## matches something like: "2012-12-31 12:35:19 +0000"
TIME_REGEX = re.compile('^(\d\d\d\d)-(\d\d)-(\d\d) (\d\d):(\d\d):(\d\d) \+\d+$')
TIME_YEAR_IDX = 1
TIME_MON_IDX = 2
TIME_DAY_IDX = 3
TIME_H_IDX = 4
...
## old ## MONTHS = {'Jan': '01', 'Feb': '02', 'Mar': '03', 'Apr': '04', 'May': '05',
## old ##           'Jun': '06', 'Jul': '07', 'Aug': '08', 'Sep': '09',
## old ##           'Oct': '10', 'Nov': '11', 'Dec': '12'}
...
def convert_twitter_time_to_orgmode_timestamp(twitter_time, timestamp_delta):
    ...
    if not components:
        logging.critical("Something fishy is going on here: twitter seemed to have changed " + \
